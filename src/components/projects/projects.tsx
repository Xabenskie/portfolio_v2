					...
					{filteredProjects.map((project, index) => (
						...
						>
							...
							<div className='relative h-48 sm:h-56 overflow-hidden'>
								...
								{/* Overlay Buttons */}
								<div className='absolute inset-0 items-center justify-center gap-4 opacity-0 group-hover:opacity-100 transition-all duration-500 transform translate-y-6 group-hover:translate-y-0 hidden md:flex'>
									{project.openSource && (
										<a
											href={project.githubUrl}
											target='_blank'
											rel='noopener noreferrer'
											className='bg-white/95 hover:bg-white focus:bg-white text-gray-800 px-4 py-2 rounded-xl font-medium transition-all duration-300 hover:scale-110 hover:shadow-lg focus:scale-110 focus:shadow-lg transform hover:-translate-y-1 focus:-translate-y-1 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2 focus:ring-offset-transparent'
										>
									...
									{project.deployed && (
										<a
											...
											target='_blank'
											rel='noopener noreferrer'
											className='bg-gradient-to-r from-[#9C27B0] to-[#651FFF] text-white px-4 py-2 rounded-xl font-medium transition-all duration-300 hover:scale-110 hover:shadow-lg focus:scale-110 focus:shadow-lg transform hover:-translate-y-1 focus:-translate-y-1 focus:outline-none focus:ring-2 focus:ring-[#9C27B0] focus:ring-offset-2 focus:ring-offset-transparent'
										>
											<span className='flex items-center gap-2'>
												<svg
													className='w-4 h-4'
								...
								<div className='flex gap-3 md:hidden'>
									{project.openSource && (
										<a
											...
											target='_blank'
											rel='noopener noreferrer'
											className='flex-1 bg-white/80 dark:bg-gray-700/80 hover:bg-white dark:hover:bg-gray-700 focus:bg-white dark:focus:bg-gray-700 text-gray-800 dark:text-gray-200 px-4 py-2 rounded-xl font-medium transition-all duration-300 text-center border border-gray-200 dark:border-gray-600 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2 focus:ring-offset-white dark:focus:ring-offset-gray-800'
										>
									...
									{project.deployed && (
										<a
											...
											target='_blank'
											rel='noopener noreferrer'
											className='flex-1 bg-gradient-to-r from-[#9C27B0] to-[#651FFF] text-white px-4 py-2 rounded-xl font-medium transition-all duration-300 text-center hover:shadow-lg focus:shadow-lg focus:outline-none focus:ring-2 focus:ring-[#9C27B0] focus:ring-offset-2 focus:ring-offset-white dark:focus:ring-offset-gray-800'
										>
											<span className='flex items-center justify-center gap-2'>
												<svg
													className='w-4 h-4'
